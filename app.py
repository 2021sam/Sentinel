...
def ss():
	...
	return render_template('ss.html', location=location, alarm=alarm_button, alarm_status=alarm_status, select_log=select_log, days=days, day=day, VIP_IN=VIP_IN, start_time_hm=start_time_hm, end_time_hm=end_time_hm)
	# return 'Hello Dude'
