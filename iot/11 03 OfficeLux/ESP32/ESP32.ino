...
int PIR = 12;     //12;       // TTGO T-Display Works
int ENFORCER = 0;   //  Seco-Larm E-931-S35RRQ Enforcer Indoor/Outdoor Wall Mounted Photoelectric Beam Sensor with 35 Foot Range
int LUX = 1;
int SONIC = 0;
int DOOR1 = 0;  //22;
int DOOR2 = 0;  //21;
